...
const buyMiningLevelUpgrade = ({ robot }: { robot: RobotData}) => makeBuyMiningLevelUpgrade({ robot, buyUpgrade: buyUpgrade, bankAccountService: bankAccountService, itemService: itemService })
